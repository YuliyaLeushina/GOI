(() => {
  ...
  function pe(e) {
    ...
    function w(e) {
      ...
      r.touch
        ? (o[p](i.start, b, c), o[p](i.move, S, c), o[p](i.end, y, d))
        : (o[p](a.start, b, c), l[p](a.move, S, c), l[p](a.end, y, d));
    }
    function T() {
      ...
      0 === l.length &&
        ...
        i.draggable && t.params.scrollbar.el && w("on"),
        a &&
  ...
  new me("max").init();
  const fe = document.querySelector(".header__wrapper"),
    ge = fe.offsetTop,
    ve = document.querySelector(".wrapper"),
    be = document.querySelector("main.page");
  window.addEventListener("scroll", function () {
    const e = window.scrollY;
    if (e > ge) {
      ve.classList.add("header-fixed");
      const e = fe.clientHeight;
      be.style.paddingTop = e + "px";
    } else e < ge && (ve.classList.remove("header-fixed"), (be.style.paddingTop = 0));
  }),
    document
    ...
    document.addEventListener("click", function (e) {
      ...
      t.classList.contains("menu__link_arrow") &&
        (e.preventDefault(), t.parentNode.classList.toggle("_hover"));
      (t.classList.contains("header__cart") ||
        t.classList.contains("icon-bag-minimal") ||
        t.classList.contains("header__cart-full") ||
        t.classList.contains("header__cart-icon")) &&
        (document.documentElement.classList.add("lock"),
        document.querySelector("body").classList.add("_cart-open"));
      t.classList.contains("cart__btn-close") &&
        (document.querySelector("body").classList.remove("_cart-open"),
        document.documentElement.classList.remove("lock"));
    });
  let Se = document.querySelectorAll(".up"),
    ye = document.querySelectorAll(".down");
  document.querySelectorAll("input").forEach((e) => {
    e.addEventListener("keypress", function (e) {
      "Enter" === e.key && (e.preventDefault(), sum());
    }),
      e.addEventListener("blur", function (t) {
        (e.value = "" === e.value ? 0 : e.value), sum();
      });
  }),
    ye.forEach((e) => {
    ...
    Se.forEach((e) => {
      e.addEventListener("click", function (t) {
        t.preventDefault(), e.previousElementSibling.stepUp(), sum();
      });
    }),
    (window.FLS = !0),
    (function (e) {
